      ...
      <div className=" py-5 lg:py-36 bg-black">
        <div className="border w-4/5 lg:w-full lg:max-w-md p-8 space-y-3 rounded-xl shadow-lg  mx-auto  text-white">
          ...
          <div className="space-y-1 text-sm">
            ...
            />
            {errors.email && <p className="text-red-500 text-sm font-bold">Email Is Required</p>}
          </div>
          {/* password */}
            <div className="space-y-1 text-sm">
            ...
            />
            {errors.password?.type === "required" && <p className="text-red-500 text-sm font-bold">Password Is Required</p>}
            {errors.password?.type === "minLength" && <p className="text-red-500 text-sm font-bold">Password Must Have At least 6 character</p>}
